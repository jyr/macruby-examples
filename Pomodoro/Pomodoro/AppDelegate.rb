...
class AppDelegate
    ...
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "Pomodoro" in the user's Library directory.
    #
    def applicationFilesDirectory
        ...
        library_url.URLByAppendingPathComponent("Pomodoro")
    end
    ...
    def managedObjectModel
        unless @managedObjectModel
          model_url = NSBundle.mainBundle.URLForResource("Pomodoro", withExtension:"momd")
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("Pomodoro.storedata")
